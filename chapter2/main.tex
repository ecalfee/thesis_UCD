...
%\begin{figure}[ht]
%\includegraphics[width=\textwidth]{chapter2/figures/mexico_lines_elev_teo_black.png}
%\caption{\color{Gray} \textbf{}\ec{I prefer colored lines because you can see which line originates with which dot when populations are close together, e.g. it's hard to tell which line goes with Amatlan here.}}
%\label{map_blacklines}
%\end{figure}
...
\input{chapter2/tables/domestication_genes}
\newpage
\newpage
